...
Hi! Welcome to the written instructions for how to assemble an IKEA Micke desk. Let’s get started. After many moves (even internationally!) I have assembled and reassembled this desk multiple times, so I thought I would lend my expertise to those looking for written instruction as well or to provide written instruction for the visually impaired. This technical guide is designed for those who have recently purchased the MICKE desk with access to a paper copy of the IKEA instruction manual, or on a dual-monitor set up. 
...
## (Pg. 6) 1: How to make the desk drawers

<div style="display:flex; gap:24px; margin-bottom:20px;">
<div style="font-size:40px; font-weight:bold;">1</div>
<div>
Note: The following drawer assembly instructions apply to one small drawer and one large (give measurements?). 
...
<div>Table Top Assembly: Use the Phillips screwdriver to screw six Cam Lock Screws into the table top, each screw standing up like a stalagmite.</div>
</div>
...
<div style="font-size:40px; font-weight:bold;">15</div>
<div>
Drawer cabinet Assembly: Attach a Drawer Runner to the outside of the larger wood panel, aligned with the internal runners, and also attach a Drawer Runner to a new large wood panel. Secure both with the Phillips screwdriver and four Drawer Screws. 
</div>
</div>
